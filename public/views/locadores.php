        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="repasse" class="form-label">Dia para Repasse</label>
                        <input type="text" class="form-control" id="repasse">
                    </div>
                </div>
            </div>
...
<script src="js/locadores.js"></script>
<link rel="stylesheet" href="css/locadores.css">